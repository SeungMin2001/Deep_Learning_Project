...
class Step4:
    def ber(self):
        ...
        autonomous_robot_topics = {
            0: {
                "keywords": ["자율주행", "위치", "지도", "센서", "경로", "주행", "카메라", "거리", "방향", "속도", "탐색", "기록", "도로"],
                "scores": [0.95, 0.90, 0.85, 0.80, 0.75, 0.70, 0.65, 0.60, 0.55, 0.50, 0.45, 0.40, 0.35]
            },
            1: {
                "keywords": ["자율주행", "경로", "로봇", "장애물", "회피", "주행", "판단", "조향", "바퀴", "제동", "도착", "멈춤", "도로"],
                "scores": [0.92, 0.87, 0.82, 0.77, 0.72, 0.67, 0.62, 0.57, 0.52, 0.47, 0.42, 0.37, 0.32]
            },
            2: {
                "keywords": ["통신", "센서", "무선", "데이터", "연결", "신호", "클라우드", "서버", "장치", "동기화", "공유", "위치"],
                "scores": [0.89, 0.84, 0.79, 0.74, 0.69, 0.64, 0.59, 0.54, 0.49, 0.44, 0.39, 0.34]
            },
            3: {
                "keywords": ["자율주행로봇", "로봇", "창고", "운반", "이동", "바퀴", "배달", "적재", "작업", "상자", "자동화", "경로", "물건"],
                "scores": [0.86, 0.81, 0.76, 0.71, 0.66, 0.61, 0.56, 0.51, 0.46, 0.41, 0.36, 0.31, 0.26]
            },
            4: {
                "keywords": ["안전", "검증", "보안", "표준", "테스트", "규격", "확인", "설계", "운영", "제어", "점검"],
                "scores": [0.83, 0.78, 0.73, 0.68, 0.63, 0.58, 0.53, 0.48, 0.43, 0.38, 0.33]
            },
            5: {
                "keywords": ["AI", "학습", "예측", "데이터", "인식", "판단", "분석", "강화", "모델", "연산", "자동", "조정", "영상"],
                "scores": [0.80, 0.75, 0.70, 0.65, 0.60, 0.55, 0.50, 0.45, 0.40, 0.35, 0.30, 0.25, 0.20]
            }
        }
        #return autonomous_robot_topics
